...
const PLUGIN_DIR = join(OPENCODE_DIR, "plugins", "idle-check");
const CONFIG_PATH = join(OPENCODE_DIR, "opencode.json");

async function deploy() {
  console.log("[deploy] Deploying idle-check plugin to .opencode/ ...");
  ...
  const pluginRef = "./plugins/idle-check/src/index.js";
